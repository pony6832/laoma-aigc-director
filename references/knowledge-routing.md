...
| 劇本轉分鏡、鏡頭、構圖、光影、運鏡、表演、聲畫、打鬥或特效 | [通用電影鏡頭基礎](cinematic-craft-foundation.md)與 `scripts/query_cinematic_grammar.py` | 當前劇本、Gate 2 鎖定、鏡頭目的與實際時長 | 平台中立導演母版、逐鏡九維判斷與可直接轉譯提示詞 |
| 指定導演、作者風格、風格對照或導演審片 | [導演風格鏡頭路由](director-style-routing.md)及 catalog 指定的一份鏡頭 | Gate 2 鎖定產物、使用者指定風格、權利邊界 | 五軸風格設計、反例、A／B 短測與逐軸審片證據 |
